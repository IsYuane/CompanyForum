...
<%--    <link href="${basePath }static/weblib/bootstrap/css/bootstrap.min.css" rel="stylesheet">--%>
    <link href="${basePath }static/weblib/fileinput/css/fileinput.min.css" rel="stylesheet">
...
<script src="${basePath }static/weblib/jquery/jquery-3.2.1.min.js"></script>
<!-- Include all compiled plugins (below), or include individual files as needed -->
<script src="${basePath }static/weblib/bootstrap/js/bootstrap.min.js"></script>
<script src="${basePath }static/weblib/fileinput/js/fileinput.min.js"></script>
...
<script src="${basePath }/static/weblib/fileinput/js/locales/zh.js"></script>
<script>
    ...
    $("#file_ID").fileinput({
        ...
        maxFileSize: 1024000, // 1GBB now, this in KB,
        minFileSize: 2, // 阻止过小文件上传
        maxFileCount: 3,
        dropZoneTitle: "拖拽文件到这里 &hellip;<br>文件名格式示例: 姓名_文件内容.zip<br>支持最多3个文件同时上传<br>上传文件会被自动打包<br>仅允许上传zip/rar/7z文件<br>总大小不超过1GB",
