...
<div class="panel panel-default" id="main" style="">
    <div class="panel-heading" style="background-color: white">
        ...
        <div style="float: right;margin-top: -100px" >
            <img width="50px" height="50px" src="${APP_PATH}/images/avatar/cat.png" class="img-rounded">
        </div>
    </div>
        ...
        <li class="list-group-item">
            <div style="height: 50px">
                ...
                <div style="width: 89%;float: left">
                    <a href="/member/${reply.employee.empName}"><strong>${reply.employee.empName}</strong></a>&nbsp;&nbsp;
...
<div class="panel panel-default" id="sidebar1" style="width: 20%;margin:1% 2% 1% 0%;float: right">
    <img src="${APP_PATH}/images/3.jpg" class="img-rounded"  width="305px" height="250px">
</div>
